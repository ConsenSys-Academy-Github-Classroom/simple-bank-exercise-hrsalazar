...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender], "Only enrolled users can make deposits");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      //require(msg.value >= withdrawAmount, "Not enough mula mate!");
      require(balances[msg.sender] >= withdrawAmount, "Not enough mula mate!");
      // 2. Transfer Eth to the sender and decrement the withdrawal amount from
      //    sender's balance
      balances[msg.sender] = balances[msg.sender] - withdrawAmount;

      address(uint160(msg.sender)).transfer(withdrawAmount);
      // for >= 0.6
